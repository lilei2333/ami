...
// import AMI.UtilsCore from 'base/core/core.utils';
...
let dataInfo = [
  [
    'adi1',
    {
      location: '../data-master/fsm/lh.orig',
      label: 'Left',
      loaded: false,
      material: null,
      materialFront: null,
  ...
  [
    'adi2',
    {
      location: '../data-master/fsm/rh.orig',
      label: 'Right',
      loaded: false,
      material: null,
      materialFront: null,
...
window.onload = function() {
  ...
  let files = ['../data-master/mgh/5ec7f26248mri.nii.gz', '../data-master/mgh/5ec7f26248mri_label.nii.gz'];
