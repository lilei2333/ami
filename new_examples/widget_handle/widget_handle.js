...
window.onload = function() {
  ...
  // const file = '../data-master/dicom/adi_brain/36749894';
  const file = '../data-master/5ec7f26248mri.nii.gz';
    ...
    threeD.addEventListener('mousedown', function(evt) {
      ...
      switch (guiObjects.type) {
        ...
        case 'Freehand':
          ...
          break;
        case 'LineBrush':
          widget = new AMI.LineBrushWidget(stackHelper.slice.mesh, controls, {
            frameIndex: stackHelper.index,
            stack: stack,
            worldPosition: intersects[0].point,
          });
