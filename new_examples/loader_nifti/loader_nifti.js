...
window.onload = function() {
  ...
  // loader1.load(
  //   '../data-master/vtk/fetalatlas_brain/cortex.vtk',
  //   function(geometry) {
  ...
  let files = t2.map(function(v) {
    return '../data-master/nifti/fetalatlas_brain/t2/' + v;
  });
  ...
  Promise.all(loadSequence)
    .then(function() {
      ...
      let stackHelper1 = new AMI.StackHelper(stack);
      ...
      // fill second renderer
      let stackHelper2 = new AMI.StackHelper(stack);
