...
/**
 * @module widgets/lineBrush
 */
const widgetsLineBrush = (three = window.THREE) => {
  ...
  return class extends Constructor {
    ...
    updateMesh() {
      ...
      this._geometry.vertices = points;
...
export { widgetsLineBrush };
export default widgetsLineBrush();
